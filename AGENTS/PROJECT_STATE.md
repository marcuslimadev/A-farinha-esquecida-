...
- E01-P13-A01 — auditado visualmente em 2026-09-26: exatamente cinco viajantes reconhecíveis nas fases corretas — Miguel `01_infancia`, Rosária `01_mae_partida`, Francisco `01_pai_partida`, Teresa e João Paulo `01_adolescente_partida`; Miguel é a única criança e olha para a casa enquanto os quatro familiares organizam bagagens simples; rostos, idades, cabelos e cores de roupa coerentes com as referências individuais, sem duplicação ou fusão; mãos, braços, pernas e ações plausíveis; casa escura de madeira sobre esteios, telhado de zinco, varanda frontal, caminho, trapiche funcional e água escura do Rio Negro preservam os locks; exatamente cinco pessoas, sem texto; PNG 1536 × 864 (16:9). Aprovação operacional sujeita a revisão editorial do autor.
...
- Produção/auditoria das páginas 14–24.

PROXIMA_ACAO:
- Ler texto, ficha, direção, locks e referências de E01-P14-A01; gerar e auditar um asset.
...
- E01-P13-A01: gerado com as cinco referências individuais aprovadas de Miguel `01_infancia`, Rosária `01_mae_partida`, Francisco `01_pai_partida`, Teresa e João Paulo `01_adolescente_partida`. Como a ferramenta aceita no máximo cinco imagens de referência, a casa não foi anexada como sexta imagem; sua arquitetura foi especificada textualmente a partir do lock e da página 01. O resultado original 1536 × 1024 foi recortado centralmente para 1536 × 864, preservando integralmente pessoas, casa, trapiche e margens úteis. PNG canônico `E01_P13_A01_ULTIMA_MANHA_V01.png`, SHA-256 `d26edb96dee1157cdb771f24796e76b07207c21237bed2d3792dab2eab3cd7e2`.
